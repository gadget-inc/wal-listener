...
// GetRetainedWALBytes returns the retained bytes of the replication slot.
func (r RepositoryImpl) GetRetainedWALBytes(ctx context.Context, slotName string) (*int64, error) {
